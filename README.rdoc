...
- Les commentaires sont liés au post à partir duquel ils sont créé, et sont lié à un utilisateur [je fais un User.find(:first) pour la liaison, aucune gestion en session]
(C'est une base !)
